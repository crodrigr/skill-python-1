...
```python
mensaje = "Aprender a programar es cuestión de práctica"
print(mensaje)
```

Escribe en dos o tres frases **dos características de Python** que puedas reconocer a
partir de este programa y de la explicación de clase (por ejemplo, sobre su legibilidad
o sobre cómo se ejecuta).
