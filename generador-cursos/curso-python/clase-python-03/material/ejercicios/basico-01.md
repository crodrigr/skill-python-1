...
1. Cree una lista con tres productos de una compra: `"arroz"`, `"aceite"`, `"leche"`.
2. Agregue `"pan"` al final de la lista.
3. Inserte `"azúcar"` en la segunda posición (índice `1`).
4. Elimine `"aceite"` de la lista (ya no se necesita).
